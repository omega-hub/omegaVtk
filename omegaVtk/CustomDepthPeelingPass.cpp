...
Module:    CustomDepthPeelingPass.cxx
...
vtkStandardNewMacro(CustomDepthPeelingPass);
vtkCxxSetObjectMacro(CustomDepthPeelingPass,TranslucentPass,vtkRenderPass);
...
// ----------------------------------------------------------------------------
CustomDepthPeelingPass::CustomDepthPeelingPass()
{
...
void CustomDepthPeelingPass::ReleaseGraphicsResources(vtkWindow *w)
{
...
// ----------------------------------------------------------------------------
void CustomDepthPeelingPass::PrintSelf(ostream& os, vtkIndent indent)
{
...
// \pre s_exists: s!=0
void CustomDepthPeelingPass::Render(const vtkRenderState *s)
{
...
// ----------------------------------------------------------------------------
void CustomDepthPeelingPass::CheckSupport(vtkOpenGLRenderWindow *w)
{
  assert("pre: w_exists" && w!=0);
...
void CustomDepthPeelingPass::CheckCompilation(
...
int CustomDepthPeelingPass::RenderPeel(const vtkRenderState *s,
                                    int layer)
{
  assert("pre: s_exists" && s!=0);
